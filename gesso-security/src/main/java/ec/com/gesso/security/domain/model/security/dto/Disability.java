...
public class Disability implements Serializable {
    ...
    public int hashCode() {
        int hash = 0;
        hash += (disabilityPK != null ? disabilityPK.hashCode() : 0);
        return hash;
    }
    ...
    public boolean equals(Object object) {
        ...
        if ((this.disabilityPK == null && other.disabilityPK != null) || (this.disabilityPK != null && !this.disabilityPK.equals(other.disabilityPK))) {
            return false;
        }
        return true;
    }
    ...
    public String toString() {
        return "ec.com.gesso.security.domain.model.security.dto.Disability[ disabilityPK=" + disabilityPK + " ]";
    }
