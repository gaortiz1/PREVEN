...
public class CurriculumVitae implements Serializable {
    ...
    public int hashCode() {
        int hash = 0;
        hash += (curriculumVitaePK != null ? curriculumVitaePK.hashCode() : 0);
        return hash;
    }
    ...
    public boolean equals(Object object) {
        ...
        if ((this.curriculumVitaePK == null && other.curriculumVitaePK != null) || (this.curriculumVitaePK != null && !this.curriculumVitaePK.equals(other.curriculumVitaePK))) {
            return false;
        }
        return true;
    }
    ...
    public String toString() {
        return "ec.com.gesso.security.domain.model.security.dto.CurriculumVitae[ curriculumVitaePK=" + curriculumVitaePK + " ]";
    }
