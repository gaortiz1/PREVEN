...
public class Title implements Serializable {
    ...
    public int hashCode() {
        int hash = 0;
        hash += (titlePK != null ? titlePK.hashCode() : 0);
        return hash;
    }
    ...
    public boolean equals(Object object) {
        ...
        if ((this.titlePK == null && other.titlePK != null) || (this.titlePK != null && !this.titlePK.equals(other.titlePK))) {
            return false;
        }
        return true;
    }
    ...
    public String toString() {
        return "ec.com.gesso.security.domain.model.security.dto.Title[ titlePK=" + titlePK + " ]";
    }
