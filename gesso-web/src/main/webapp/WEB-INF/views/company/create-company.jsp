							...
							<div class="col-xs-12">
								...
								<form:form class="form-horizontal" role="form">
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right"><spring:message code="page.label.company.razonSocial"/></label>
										<div class="col-sm-9">
											<form:input path="razonSocial" placeholder="Razón Social" cssClass="txt-validate-empty" size="35" title="Razón Social" required="required"/>
										</div>
									</div>
									
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right"><spring:message code="page.label.ruc"/></label>

										<div class="col-sm-9">
											<form:input path="ruc" placeholder="Ruc" cssClass="txt-validate-empty" size="35" title="Ruc" required="required" maxlength="13"/>
										</div>
									</div>
									
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right"><spring:message code="page.label.company.nombreComercial"/></label>

										<div class="col-sm-9">
											<form:input path="nombreComercial" placeholder="Nombre Comercial" cssClass="txt-validate-empty" size="35" title="Nombre Comercial" required="required"/>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<form:textarea path="actividadComercialPrincipal" placeholder="Actividad económica principal" cssClass="txt-validate-empty" rows="2" cols="50" required="required"/>
										</div>
									</div>	
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<span class="input-icon">
												<form:input path="telefono" cssClass="input-mask-phone" required="required"/>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right"><spring:message code="page.label.direccion"/></label>
										<div class="col-sm-9">
											<form:input path="direccion" placeholder="Dirección" cssClass="txt-validate-empty" size="35" required="required"/>
										</div>
									</div>
									
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right"><spring:message code="page.label.email" /></label>

										<div class="col-sm-9">
											<form:input path="email" data-rel="tooltip" placeholder="Tooltip on hover" title="Email principal" data-placement="bottom" type="email" autocomplete="true" maxlength="113" size="35" required="required"/>
											<span class="help-button" data-rel="popover" data-trigger="hover" data-placement="left" data-content="Este sera el email al cual se notificaran las novedades" title="Email principal">?</span>
										</div>
									</div>
