					...
					<div class="row mt">
						<div class="col-lg-12">
							<div class="form-panel">
									<h4 class="mb"><i class="fa fa-angle-right"></i>Nueva Compañia</h4>
									...
									<div class="form-group">
										...
										<div class="col-sm-6">
											<form:input path="razonSocial" placeholder="Razón Social" cssClass="form-control" size="35" title="Razón Social" required="required" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-6">
											<form:input path="actividadComercialPrincipal" placeholder="Actividad económica principal" cssClass="form-control" size="255" title="Actividad económica principal" required="required" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-6">
											<form:input path="actividadComercialSecuandaria" placeholder="Actividad económica secundaria" cssClass="form-control" size="255" title="Actividad económica secundaria" required="required" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-6">
											<form:select path="typesCompanies"
												...
												data-placeholder="Seleccione tipo compañia..."
												required="required">
									...
									<div class="form-group">
										...
										<div class="col-sm-6">
											<form:input path="direccion" placeholder="Dirección" cssClass="form-control" size="255" title="Actividad económica secundaria" required="required" />
										</div>
									</div>
