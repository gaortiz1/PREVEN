...
<head>
    ...
    <script src="${pageContext.request.contextPath}/resources/assets/js/flot/jquery.flot.js"></script>
    <script src="${pageContext.request.contextPath}/resources/assets/js/flot/jquery.flot.pie.js"></script>
    <script src="${pageContext.request.contextPath}/resources/assets/js/flot/jquery.flot.resize.js"></script>
                    ...
                    <ul class="dropdown-menu-right dropdown-navbar dropdown-menu dropdown-caret dropdown-close">
                        ...
                        <li class="dropdown-content">
                            <ul class="dropdown-menu dropdown-navbar">
                                ...
                                <li>
                                    <a href="#" class="clearfix">
                                        <img src="${pageContext.request.contextPath}/resources/assets/avatars/avatar2.png" class="msg-photo" alt="Kate's Avatar" />
												<span class="msg-body">
													<span class="msg-title">
                                ...
                                <li>
                                    <a href="#" class="clearfix">
                                        <img src="${pageContext.request.contextPath}/resources/assets/avatars/avatar5.png" class="msg-photo" alt="Fred's Avatar" />
												<span class="msg-body">
													<span class="msg-title">
                                                ...
                                                <div id="member-tab" class="tab-pane">
                                                    ...
                                                    <div class="clearfix">
                                                        <div class="itemdiv memberdiv">
                                                            <div class="user">
                                                                <img alt="Bob Doe's avatar" src="${pageContext.request.contextPath}/resources/assets/avatars/user.jpg" />
                                                            </div>
                                                        ...
                                                        <div class="itemdiv memberdiv">
                                                            <div class="user">
                                                                <img alt="Joe Doe's avatar" src="${pageContext.request.contextPath}/resources/assets/avatars/avatar2.png" />
                                                            </div>
                                                        ...
                                                        <div class="itemdiv memberdiv">
                                                            <div class="user">
                                                                <img alt="Jim Doe's avatar" src="${pageContext.request.contextPath}/resources/assets/avatars/avatar.png" />
                                                            </div>
                                                        ...
                                                        <div class="itemdiv memberdiv">
                                                            <div class="user">
                                                                <img alt="Alex Doe's avatar" src="${pageContext.request.contextPath}/resources/assets/avatars/avatar5.png" />
                                                            </div>
                                                        ...
                                                        <div class="itemdiv memberdiv">
                                                            <div class="user">
                                                                <img alt="Bob Doe's avatar" src="${pageContext.request.contextPath}/resources/assets/avatars/avatar2.png" />
                                                            </div>
                                                        ...
                                                        <div class="itemdiv memberdiv">
                                                            <div class="user">
                                                                <img alt="Susan's avatar" src="${pageContext.request.contextPath}/resources/assets/avatars/avatar3.png" />
                                                            </div>
                                                        ...
                                                        <div class="itemdiv memberdiv">
                                                            <div class="user">
                                                                <img alt="Phil Doe's avatar" src="${pageContext.request.contextPath}/resources/assets/avatars/avatar4.png" />
                                                            </div>
                                                        ...
                                                        <div class="itemdiv memberdiv">
                                                            <div class="user">
                                                                <img alt="Alexa Doe's avatar" src="${pageContext.request.contextPath}/resources/assets/avatars/avatar1.png" />
                                                            </div>
                                                ...
                                                <div id="comment-tab" class="tab-pane">
                                                    ...
                                                    <div class="comments">
                                                        <div class="itemdiv commentdiv">
                                                            <div class="user">
                                                                <img alt="Bob Doe's Avatar" src="${pageContext.request.contextPath}/resources/assets/avatars/avatar.png" />
                                                            </div>
                                                        ...
                                                        <div class="itemdiv commentdiv">
                                                            <div class="user">
                                                                <img alt="Jennifer's Avatar" src="${pageContext.request.contextPath}/resources/assets/avatars/avatar1.png" />
                                                            </div>
                                                        ...
                                                        <div class="itemdiv commentdiv">
                                                            <div class="user">
                                                                <img alt="Joe's Avatar" src="${pageContext.request.contextPath}/resources/assets/avatars/avatar2.png" />
                                                            </div>
                                                        ...
                                                        <div class="itemdiv commentdiv">
                                                            <div class="user">
                                                                <img alt="Rita's Avatar" src="${pageContext.request.contextPath}/resources/assets/avatars/avatar3.png" />
                                                            </div>
